...
public class MArc {
	 ...
	 * @see PetriNode
	 */
	public MArc(String _id, PetriNode _source, PetriNode _target, Integer _weight) throws IllegalArgumentException {
	 ...
	 * @see PetriNode 
	 */
	public MArc(String _id, PetriNode _source, PetriNode _target, Integer _weight, ArcType _type) throws IllegalArgumentException{
