"""
Convierte el archivo de MATRICES (I+ , I-) extraido del Petrinator (.html) a un archivo '.txt' que luego será utilizado en el algoritmo
...
def main():
    ...
    archivo = os.path.dirname(os.path.realpath(__file__)) + "/tmp/mat.html"
    html = open(archivo,'r')
